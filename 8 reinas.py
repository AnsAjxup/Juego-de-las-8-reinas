...
class nreinas:
    ...
    #inicializa la posicion, el tamaño para luego mostrar el resultado
    def resuelve(self):
        posicion = [-1] * self.tamaño
        self.poner_reina(posicion, 0)
        print("se encontraron", self.results, "soluciones")

    #funcion que valida las posisciones de las reinas
    ...
    #revisa que no haya reinas bajo ataque
